...
class AgentEnv(gym.Env):
    def __init__(self):     
        ...
        self.action = 0
        self.reward = 0
        self.observation_space = gym.spaces.Box(np.array([0,0,0,0]),np.array([self.width,self.height,self.width,self.height]))
    ...
    def step(self,action):        
        ...
        state1 = np.array([self.player.x,self.player.y,self.obstacle1_pos[0],self.obstacle1_pos[1]])
    ...
    def reset(self):
        ...
        return np.array([self.player.x,self.player.y,self.obstacle1_pos[0],self.obstacle1_pos[1]])
